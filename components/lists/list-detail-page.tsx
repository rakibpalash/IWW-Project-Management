...
const DEFAULT_VISIBLE_COLS: VisibleCols = {
  assignee:  true,
  dueDate:   true,
  startDate: false,
  size:      true,
...
const COL_LABELS: Record<keyof VisibleCols, string> = {
  assignee:  'Assignee',
  dueDate:   'Due Date',
...
export function ListDetailPage({
  ...
  const [visibleCols, setVisibleCols]     = useState<VisibleCols>(DEFAULT_VISIBLE_COLS)
